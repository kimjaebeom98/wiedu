...
public enum ErrorCode {
    ...
    REVIEW_STUDY_NOT_COMPLETED(HttpStatus.BAD_REQUEST, "RV005", "완료된 스터디에만 리뷰를 작성할 수 있습니다."),
    REVIEW_SELF_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "RV006", "자기 자신에게는 리뷰를 작성할 수 없습니다."),
    REVIEW_TARGET_NOT_MEMBER(HttpStatus.BAD_REQUEST, "RV007", "리뷰 대상자가 스터디 멤버가 아닙니다."),
